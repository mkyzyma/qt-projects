    ...
    if (drop)
    {
      switch (pass)
      {
        ...
        case 2:
        {
          ...
          db.execute ("DROP TABLE IF EXISTS \"LoanState\" CASCADE");
      ...
      switch (pass)
      {
        case 1:
        {
          ...
          db.execute ("CREATE TABLE \"LoanPayment\" (\n"
                      ...
                      "    REFERENCES \"Loan\" (\"id\")\n"
                      "    INITIALLY DEFERRED)");
          db.execute ("CREATE TABLE \"LoanState\" (\n"
                      "  \"isDeleted\" BOOLEAN NOT NULL,\n"
                      "  \"deleteTime\" TIMESTAMP NULL,\n"
                      "  \"deletedBy\" BIGINT NULL,\n"
                      "  \"createTime\" TIMESTAMP NULL,\n"
                      ...
                      "    REFERENCES \"Loan\" (\"id\")\n"
                      "    INITIALLY DEFERRED,\n"
                      "  CONSTRAINT \"idLoanPayment_fk\"\n"
                      "    FOREIGN KEY (\"idLoanPayment\")\n"
                      "    REFERENCES \"LoanPayment\" (\"id\")\n"
                      "    INITIALLY DEFERRED)");
        ...
        case 2:
        {
          db.execute ("ALTER TABLE \"Person\"\n"
                      ...
                      "    REFERENCES \"Member\" (\"id\")\n"
                      "    INITIALLY DEFERRED");
          db.execute ("ALTER TABLE \"Loan\"\n"
                      "  ADD CONSTRAINT \"idState_fk\"\n"
                      "    FOREIGN KEY (\"idState\")\n"
                      "    REFERENCES \"LoanState\" (\"id\")\n"
                      "    INITIALLY DEFERRED");
